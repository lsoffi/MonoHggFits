...
from combine_maker_All import CombineApp
        ...
        super(BiasApp,self).__init__(
            option_groups=[
                ("Bias study options", [
                        ...
                        make_option("--fit-mc",dest="fit_mc",action="store_true",default=True,
                                    help="Fitting mc.. no blinding is needed",
                                    ),
    ...
    def throwToys(self,options,args):
        ...
        for comp,model in zip(options.components,options.models):
            ...
            for cat in fit["categories"]:
                ...
                treename = "mctruth_all_%s_%s" % (fitname,cat)
                
                print treename
                #print treename.GetEntries()
                ...
                if options.throw_from_model:
                    ...
                    frame.GetYaxis().SetRangeUser( 1.e-3,50000. )
                    frame.Draw()
